...
<html>
   ...
   ERxx = /[@!#$%&*+=?|-]/;
                        ...
                        d.innerHTML = 'Seguranca da senha: <font color=\'red\'> BAIXA</font>';
                                ...
                                if (valor.length === 8 && valor.sea rch(ERaz) !== - 1 && valor.search(ERAZ) != = - 1 && valor.search(ER09) !== - 1 || valor.length > 7 && valor.search(ERaz) !== - 1 && valor.search(ERAZ) !== - 1 && valor.search(ERxx) || valor.length > 7 && valor.search(ERaz) !== - 1 && valor.search(ERxx) !== - 1 && valor.search(ER09) || valor.length > 7 && valor.search(ERxx) !== - 1 && valor.search(ERAZ) !== - 1 && valor.search(ER09)){
...
document.getElementById("em            ail_cad").focus();
return false;
}
}
</script> 
